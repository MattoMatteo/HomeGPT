...
activation_words = ("gennà","jenna","gennaro","jennaro","genna","jennà") # a tuple of words that trigger speech recognition
...
#MQTT
        #set ip or hostname
mqtt_host = "192.168.178.58" 
mqtt_username = "homeassistant"
matt_password = "aev6cujooTuu7haeng1xidai8moh8ahneido5KaingohFooPh5xeah5Iewogoong"
mqtt_port = 1883
        #topic listening FROM broker
mqtt_topic_subscription = "genna/ascolta" 
        #publication topic TO THE broker
mqtt_topic_publication = "genna/risponde" 
