...
class recognitionLanguageCode(Enum):
    AFRIKAANS = "af"
    ALBANIAN = "sq"
    AMHARIC = "am"
    ...
    ARMENIAN = "hy"
    ASSAMESE = "as"
    AZERI_CYRILLIC = "az-az"
    AZERI_LATIN = "az-az"
    BASQUE = "eu"
    BELARUSIAN = "be"
    BENGALI_BANGLADESH = "bn"
    BENGALI_INDIA = "bn"
    BOSNIAN = "bs"
    BULGARIAN = "bg"
    BURMESE = "my"
    ...
    MONGOLIAN = "mn"
    NEPALI = "ne"
    NORWEGIAN_BOKMAL = "no-no"
    NORWEGIAN_NYNORSK = "no-no"
    ORIYA = "or"
    POLISH = "pl"
    PORTUGUESE_BRAZIL = "pt-br"
    PORTUGUESE_PORTUGAL = "pt-pt"
    PUNJABI = "pa"
    ROMANIAN_MOLDOVA = "ro-mo"
    ROMANIAN_ROMANIA = "ro"
    RUSSIAN = "ru"
    RUSSIAN_MOLDOVA = "ru-mo"
    SANSKRIT = "sa"
